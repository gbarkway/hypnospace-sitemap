        ...
        <Modal show={show} onHide={onCloseButtonClick} animation={false} centered>
            ...
            <Modal.Body>
                ...
                <ul>
                    ...
                    <li><b>Zoom:</b> scroll (mouse) or pinch and zoom (touchscreen)</li>
                    <li><b><img src={calIcon} alt="calendar"></img>:</b> change date</li>
                    <li><b><img src={searchIcon} alt="help"></img>: </b> search!</li>
                </ul>
                <p>Zones are big rectangles. Click on one to get started!</p>
            </Modal.Body>
            <Modal.Footer className="justify-content-between">
                <div>
                    <a className="mx-2 small" target="_blank" rel="noreferrer" href="/licenses">Licenses</a>
                    <a className="mx-2 small" target="_blank" rel="noreferrer" href="https://github.com/gbarkway/hypnospace-sitemap">GitHub</a>
                </div>
